...
public class Student {
	...
	private double average; // 평균,(scores 종속)
	private char grade; // 학점(A~F),(scores 종속)
	private boolean isPass; // 합격유무(평균 60이상 "합격"),(scores 종속)
	...
	public void setScores(int scoreCount) {
		...
		double average = (double)total / scores.length; // length도 double로 자동으로 바뀐다.
		setAverage(average);
		// 학점 구하기 && 합격 유무
	...
	public void info() {
		...
		System.out.println("평균 : " + new DecimalFormat("0.00").format(average) + "점"); // 소수2자리만 출력
