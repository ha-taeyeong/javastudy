...
public class Ex01_operator {
	...
	public static void main(String[] args) {
		...
		int b = 10;
		System.out.println(--b); // 9, a를 먼저 감소시키고 출력합니다.
		System.out.println(b--); // 9, a를 먼저 출력시키고 감소시킵니다.
		...
		// a += 1; : a = a + 1;
		// a -= 1; : a = a - 1; 주의) a =- 1은  a는 -1에 대입한다는 의미이다.
		// a *= 1; : a = a * 1;
		// a /= 1; : a = a / 1;
		// a %= 1; : a = a % 1;
		// 문제. money를 5% 증가시켜보세요.
		int money = 100;
//		money = money + (money * 0.05); 정수 = 정수+실수이므로 실행 안된다.(casting을 해줘됨)
